...
namespace Retro.Communication.Packets.Incoming
{
    public class ClientPacket
    {
        ...
        private int Pointer;
        private int moderatorSupportTicketMessageComposer;
        ...
        public ClientPacket(int moderatorSupportTicketMessageComposer)
        {
            this.moderatorSupportTicketMessageComposer = moderatorSupportTicketMessageComposer;
        }
        ...
        {
            return "[" + Header + "] BODY: " + (RetroEnvironment.GetDefaultEncoding().GetString(Body).Replace(Convert.ToChar(0).ToString(), "[0]"));
        }
        ...
        {
            return RetroEnvironment.GetDefaultEncoding().GetString(ReadFixedValue());
        }
