...
using Retro.Communication.Packets.Incoming.Rooms.Session;

namespace Retro.Communication.Packets
{
    public sealed class PacketManager
    {
        private static readonly ILog log = LogManager.GetLogger("Habbie.Communication.Packets");
        ...
        public void TryExecutePacket(GameClient Session, ClientPacket Packet)
        {
            /*if (!_incomingPackets.TryGetValue(Packet.Id, out IPacketEvent Pak))
            {
                if (System.Diagnostics.Debugger.IsAttached || ExtraSettings.DEBUG_ENABLED == true)
                    if (_packetNames.ContainsKey(Packet.Id))
                        Logger.Debug("Received Packet: [Unknown] " + _packetNames[Packet.Id]);
                    else
            ...
            {
                if (System.Diagnostics.Debugger.IsAttached || ExtraSettings.DEBUG_ENABLED == true)
                    log.Debug("Unknown Packet: " + Packet.ToString());
                return;
            }
        ...
        {
            //Session
            _incomingPackets.Add(ClientPacketHeader.OpenConnectionMessageComposer, new OpenConnectionComposer());
        }
        #endregion
        ...
        public void RegisterNames()
        {
            ...
            #endregion
            #region Messenger
            _packetNames.Add(ClientPacketHeader.BuddyListMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.BuddyRequestsMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.FindFriendsProcessResultMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.FollowFriendFailedMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.FriendListUpdateMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.FriendNotificationMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.HabboSearchResultMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.InstantMessageErrorMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.MessengerErrorMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.MessengerInitMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.NewBuddyRequestMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.NewConsoleMessageMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.RoomInviteMessageComposer, "AchievementProgressedMessageComposer");
            #endregion
            #region Misc
            ...
            #endregion
            #region Quests
            _packetNames.Add(ClientPacketHeader.QuestAbortedMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.QuestCompletedMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.QuestListMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.QuestStartedMessageComposer, "AchievementProgressedMessageComposer");
            #endregion
            #region QuickPolls
            ...
            #endregion
            #region Notifications
            _packetNames.Add(ClientPacketHeader.AlertNotificationHCMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.HCGiftsAlertComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.MassEventComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.RoomCustomizedAlertComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.RoomErrorNotifMessageComposer, "AchievementProgressedMessageComposer");
            #endregion
            #region Nux
            ...
            _packetNames.Add(ClientPacketHeader.OpenConnectionMessageComposer, "OpenConnectionMessageComposer");
            ...
            #endregion
            #region Sound
            _packetNames.Add(ClientPacketHeader.LoadJukeboxUserMusicItemsMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.SetJukeboxNowPlayingMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.SetJukeboxPlayListMessageComposer, "AchievementProgressedMessageComposer");
            ...
            _packetNames.Add(ClientPacketHeader.SoundSettingsMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.TraxSongInfoMessageComposer, "AchievementProgressedMessageComposer");
            #endregion
            #region Talents
            ...
            _packetNames.Add(ClientPacketHeader.GetRelationshipsMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.HabboGroupBadgesMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.HabboUserBadgesMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.IgnoredUsersMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.NameChangeUpdateMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.ProfileInformationMessageComposer, "AchievementProgressedMessageComposer");
            _packetNames.Add(ClientPacketHeader.RespectNotificationMessageComposer, "AchievementProgressedMessageComposer");
