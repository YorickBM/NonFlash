...
namespace Engine.Navigator
{
    ...
    class NavRoomSectionCombiner {
        private List<Image> images;
        private List<Font> fonts;

        public NavRoomSectionCombiner()
        {
            images = new List<Image>();
            fonts = new List<Font>();
        }

        public NavRoomSectionCombiner AddSection(NavRoomSection section)
        {
        ...
        public NavRoomSectionCombiner AddSections(NavRoomSection[] sections)
        {
