...
{
    class InMenuButton : ICloneable
    {
        internal ToggleHoverButton cornerLeft, cornerRight, edgeTop, edgeLeft, edgeRight, backdrop, edgeBottom;
        internal Vector2i size, Position;
        internal Font buttonName;
        internal bool useLanguage;
        internal MyAction actionStored;
        ...
        public void SetWidth(int X) { this.size = new Vector2i(X, GetSize().Y); }
        public void SetAction(MyAction action) { if (this.cornerLeft != null) this.cornerLeft.SetAction(action, 0); else Logger.DebugWarn("Could not set menu action"); }
        public void SetName(string name) { this.buttonName.SetText(name); }

        public void ToggleLanguageManager() { useLanguage = !useLanguage; }
        ...
        public void SetActive(bool value = true, bool doAction = false)
        {
            if (doAction) cornerLeft.getActiveButton().clickAction.Invoke();
        ...
        public void Trigger()
        {
            cornerLeft.getActiveButton().clickAction.Invoke();
        }
