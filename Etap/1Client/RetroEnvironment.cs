...
namespace Etap
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Etap.RetroEnvironment");
        ...
        public static void Initialize()
        {
            ...
            try
            {
                ...
                Logger.Info("Setting up LanguageManager");
        ...
        private static void PerformShutDown(bool restart)
        {
            //Console.Clear();
            Logger.Info("Server shutting down...");
            Console.Title = PrettyVersion + " CLIENT: SHUTTING DOWN!";
        ...
        public static int ButtonDelay = 150;
        public static void CompleteShutdown()
        {
            ...
            {
                Logger.Warn("No active game found! Shutdown too early??");
            }
