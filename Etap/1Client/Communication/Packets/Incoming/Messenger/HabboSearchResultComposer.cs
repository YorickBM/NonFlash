...
namespace Retro.Communication.Packets.Outgoing.Messenger
{
	class HabboSearchResultComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.HabboSearchResultMessageComposer)
        {
            ...
            {
                bool Online = (RetroEnvironment.GetGame().GetClientManager().GetClientByUserID(Friend.UserId) != null);
            ...
            {
                bool Online = (RetroEnvironment.GetGame().GetClientManager().GetClientByUserID(OtherUser.UserId) != null);
